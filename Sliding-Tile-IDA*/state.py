...
# Initial the puzzles as 2d array list
    def __init__(self,
...
# Get the Manhattan Distances
    ...
    def set_distance(self):
        self.this_distance = int(np.absolute(self.this_state.take(1, axis=2).flatten()).sum() +
                             np.absolute(self.this_state.take(2, axis=2).flatten()).sum() / 10)

    def get_distance(self) -> int:
        return self.this_distance
    ...
    def gen_next_state(self, th: int = 0) -> bool:
        ...
        self.this_distance -= next_states[th][0]
    ...
    # check if this function is solveable    
    ...
    def __lt__(self, other):
        ...
        return self.this_distance < other.this_distance
